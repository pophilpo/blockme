...
First off, thank you for considering contributing to blockme.
...
[issue-tracker]: https://github.com/{[username]}/blockme/issues
...
```shell
git clone https://github.com/{[username]}/blockme
cd blockme
cargo build
```
